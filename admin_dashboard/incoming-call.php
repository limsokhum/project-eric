										...
										<ul>
											<li>
												<a href="">
													...
													<span class="call-mute"><i class="fas fa-microphone-slash"
														...
														<ul class="user-det-list">
															...
															<li>
																...
																<span class="float-right text-muted"><a
																		...
																		class="__cf_email__"
																		data-cfemail="244e4b4c4a404b4164415c45495448410a474b49">[email&#160;protected]</a></span>
															</li>
															<li>
																<span>Phone:</span>
																<span
				...
				<div class="modal-body">
					<div class="profile-widget">
						<div class="profile-img">
							<a href="my-profile.html" class="avatar"><img src="assets/img/user-03.jpg" alt=""></a>
						</div>
						<h4 class="user-name m-t-10 m-b-0 text-ellipsis"><a href="my-profile.html">Tressa Wexler</a>
						</h4>
						<div class="small text-muted">calling ...</div>
						<div class="incoming-btns">
							<a href="chat.html" class="btn btn-success m-r-10">Decline</a>
							<a href="voice-call.html" class="btn btn-danger">Answer</a>
						</div>
					</div>
				</div>
			</div>
