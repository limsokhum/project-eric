                            ...
                            <div class="card-body">
                                <div class="popover-list">
                                    ...
                                    <a class="example-popover btn btn-primary" tabindex="0" role="button"
                                        ...
                                        popover</a>
                                    <button class="example-popover btn btn-primary" type="button" data-trigger="hover"
                                        data-container="body" data-toggle="popover" data-placement="bottom"
                                        title="Popover title" data-offset="-20px -20px"
                                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">On
                            ...
                            <div class="card-body">
                                <div class="popover-list">
                                    <button class="example-popover btn btn-primary" type="button" data-container="body"
                                        data-toggle="popover" data-placement="top" title="Popover title"
