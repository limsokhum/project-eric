            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-12 text-right add-btn-col">
                        <a href="add-employee.html" class="btn btn-primary btn-rounded float-right"><i
                                class="fas fa-plus"></i> Add Employees</a>
                        <div class="view-icons">
                            <a href="all-employees.html" class="grid-view btn btn-link active"><i
                                    class="fas fa-th"></i></a>
                            <a href="employees-list.html" class="list-view btn btn-link"><i class="fas fa-bars"></i></a>
                        </div>
                    </div>
                </div>
