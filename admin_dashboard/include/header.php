<div class="header-outer">
    <div class="header">
        ...
        <a id="toggle_btn" class="float-left" href="javascript:void(0);">
            <img src="assets/img/sidebar/icon-21.png" alt="" width="40">
        </a>
        ...
        <ul class="nav float-left">
            ...
            <li>
                <a href="index.html" class="mobile-logo d-md-block d-lg-none d-block">
                    <img src="assets/img/logo1.png" alt="" width="40"></a>
            </li>
        </ul>
        ...
        <ul class="nav user-menu float-right">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class=" nav-link user-link" data-toggle="dropdown">
                    <span class="user-img"><img class="rounded-circle" src="assets/img/admin.png" width="30"
                            alt="Admin">
                        <span class="status online"></span></span>
                    <span>Chan Sokhom</span>
                </a>
