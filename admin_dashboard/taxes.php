                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-6 text-right add-btn-col">
                            <a href="#" class="btn btn-primary btn-rounded" data-toggle="modal"
                                data-target="#add_tax"><i class="fas fa-plus"></i> Add Tax</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                                                ...
                                                <div class="dropdown action-label">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#"><i
                                                                class="far fa-dot-circle text-success"></i> Active</a>
                                                        <a class="dropdown-item" href="#"><i
                                                                class="far fa-dot-circle text-danger"></i> Inactive</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-right">
                                                <div class="dropdown dropdown-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                            data-target="#edit_tax" title="Edit"><i
                                                                class="fas fa-pencil-alt m-r-5"></i> Edit</a>
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                            data-target="#delete_tax" title="Delete"><i
