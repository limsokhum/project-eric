                                            ...
                                            <div class="col-sm-6 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"
                                                        placeholder="Teacher Address">5754 Airport Rd, Coosada, AL, 36020</textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"
                                                        placeholder="Billing Address">5754 Airport Rd, Coosada, AL, 36020</textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <table class="table custom-table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>1</td>
                                                                <td>
                                                                    <input class="form-control" value="Vehicle Module"
                                                                ...
                                                                <td>
                                                                    <input class="form-control" readonly=""
                                                                        style="width:120px" type="text" value="112">
                                                                </td>
