            ...
            <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-12 text-right add-btn-col">
                        <a class="btn btn-primary btn-rounded float-right" href="add-blog.html"><i
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="blog grid-blog">
                            ...
                            <div class="blog-content">
                                ...
                                <a href="blog-details.html" class="read-more"><i class="fas fa-long-arrow-alt-right"
